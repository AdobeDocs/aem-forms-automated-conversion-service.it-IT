...
1. **È possibile convertire un modulo di Microsoft Word in moduli adattivi?**
   ...
   1. Utilizza Adobe Acrobat per [convertire i PDF forms prodotti in moduli PDF compilabili](https://helpx.adobe.com/it/acrobat/how-to/convert-word-excel-paper-pdf-forms.html).
...
1. **Come si crea un modulo PDF abilitato per Adobe Sign?**
   ...
   Aggiungi [tag di testo Adobe Sign](https://helpx.adobe.com/it/sign/using/text-tag.html) ai nomi dei campi o utilizza l&#39;opzione [Converti in Adobe Sign Form](https://helpx.adobe.com/it/sign/using/create-forms-with-acrobat.html).
